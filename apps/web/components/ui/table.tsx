...
/**
 * The wrapper owns `overflow-auto`, not the table: a booking or payout table on a phone must
 * scroll inside its own box rather than making the whole page scroll sideways.
 */
